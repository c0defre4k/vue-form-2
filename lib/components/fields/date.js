    ...
    return merge.recursive(Field(), {
        ...
        mounted: function() {
            ...
            this.datepicker.on('apply.daterangepicker', function(ev, picker) {
              ...
              console.log('apply', picker.startDate.format(), picker.startDate.utc().format())
                this.curValue = this.range?
                    {start:picker.startDate.utc(), end:picker.endDate.utc()}:
                    picker.startDate.utc();
              console.log('after:apply', this.curValue, this.curValue.isUTC())
        ...
        methods: {
            ...
            updateValue: function(e) {
                ...
                console.log('updateCurValue', val, val.isUTC())
                this.curValue = val;
            ...
            setValue: function(val) {
                ...
                try {
                    if (this.range) {
                        ...
                        if (typeof val.start=='string') val.start = moment.utc(val.start, DATE_FORMAT);
                        if (typeof val.end=='string') val.end = moment.utc(val.end, DATE_FORMAT);
                    } else {
                        if (typeof val=='string') val = moment.utc(val, DATE_FORMAT);
                    }
                ...
                console.log('setValue', val.isUTC())
                this.curValue = val;
            ...
            setDatepickerValue: function(value) {
                ...
                this.datepicker.data('daterangepicker').setStartDate(start.local());
                this.datepicker.data('daterangepicker').setEndDate(end.local());
            }
        },
        computed: {
            type: function() {
            ...
            formattedDate :function() {
                ...
                if (!this.range) return this.curValue.local().format(this.format);

                return this.curValue.start.local().format(this.format) + " - " + this.curValue.end.local().format(this.format);
        ...
        watch: {
            curValue: function(newVal, oldVal) {
              console.log('watch:curValue', newVal.format(), oldVal ? oldVal.format() : null)
